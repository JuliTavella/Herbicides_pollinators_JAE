...
#CONTROL NO MODIFIERS- NO HAY PESO DE LAS PRÁCTICAS CULTURALES ASOCIADAS
...
#save table
write.table(tabla_final_modifiers, file = "G:\\Mi unidad\\Herbicides_pollination_Julia\\JAE\\JAE R1\\CONTROL_NO_MODIFIERS_SC3.csv", sep = ",", row.names=F)
